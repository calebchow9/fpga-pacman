...
module lab62soc_mm_interconnect_0 (
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> leds_pio_s1_agent:cp_valid
	wire  [105:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> leds_pio_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // leds_pio_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [12:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> leds_pio_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> leds_pio_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> leds_pio_s1_agent:cp_endofpacket
	...
	wire   [12:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> hex_digits_pio_s1_agent:cp_channel
	...
	wire   [12:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire          cmd_mux_012_src_valid;                                                              // cmd_mux_012:src_valid -> spi0_spi_control_port_agent:cp_valid
	wire  [105:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> spi0_spi_control_port_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // spi0_spi_control_port_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> spi0_spi_control_port_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                                      // cmd_mux_012:src_startofpacket -> spi0_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                        // cmd_mux_012:src_endofpacket -> spi0_spi_control_port_agent:cp_endofpacket
	...
	wire          leds_pio_s1_agent_rp_valid;                                                         // leds_pio_s1_agent:rp_valid -> router_006:sink_valid
	wire  [105:0] leds_pio_s1_agent_rp_data;                                                          // leds_pio_s1_agent:rp_data -> router_006:sink_data
	wire          leds_pio_s1_agent_rp_ready;                                                         // router_006:sink_ready -> leds_pio_s1_agent:rp_ready
	wire          leds_pio_s1_agent_rp_startofpacket;                                                 // leds_pio_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          leds_pio_s1_agent_rp_endofpacket;                                                   // leds_pio_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          spi0_spi_control_port_agent_rp_valid;                                               // spi0_spi_control_port_agent:rp_valid -> router_014:sink_valid
	wire  [105:0] spi0_spi_control_port_agent_rp_data;                                                // spi0_spi_control_port_agent:rp_data -> router_014:sink_data
	wire          spi0_spi_control_port_agent_rp_ready;                                               // router_014:sink_ready -> spi0_spi_control_port_agent:rp_ready
	wire          spi0_spi_control_port_agent_rp_startofpacket;                                       // spi0_spi_control_port_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          spi0_spi_control_port_agent_rp_endofpacket;                                         // spi0_spi_control_port_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          leds_pio_s1_agent_rdata_fifo_src_valid;                                             // leds_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] leds_pio_s1_agent_rdata_fifo_src_data;                                              // leds_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          leds_pio_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_004:in_0_ready -> leds_pio_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> leds_pio_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> leds_pio_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // leds_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> leds_pio_s1_agent:rdata_fifo_sink_error
	...
	wire          spi0_spi_control_port_agent_rdata_fifo_src_valid;                                   // spi0_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] spi0_spi_control_port_agent_rdata_fifo_src_data;                                    // spi0_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          spi0_spi_control_port_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_012:in_0_ready -> spi0_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                                  // avalon_st_adapter_012:out_0_valid -> spi0_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                                   // avalon_st_adapter_012:out_0_data -> spi0_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                                  // spi0_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                                  // avalon_st_adapter_012:out_0_error -> spi0_spi_control_port_agent:rdata_fifo_sink_error
